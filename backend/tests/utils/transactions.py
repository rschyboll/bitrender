"""Contains utilities for testing database transactions"""
...
Selector = Callable[..., Coroutine[Any, Any, T] | Awaitable[T]]


class TransactionTest(Generic[T1, T2]):
    ...
    async def __call__(self) -> tuple[T1, T2]:
        ...
        Returns:
            tuple[T1, T2]: Return values of the selectors"""
    ...
    async def __in_transaction(self, select: Selector[T], wait: bool, *args: Any) -> T:
