// Generated by kea-typegen on Mon, 24 Oct 2022 16:36:27 GMT. DO NOT EDIT THIS FILE MANUALLY.

import type { Logic } from 'kea'

import type { IRouteLogic } from '../../../interfaces/index'
import type { IRoleService } from '../../../../services/interfaces/index'
import type { IRoleConverters } from '../../../../converters/interfaces/index'
import type { LoadState } from '../../../../types/index'
import type { RoleColumns, RoleTableView, RoleView } from '../../../../schemas/role'
...
export interface logicType extends Logic {
  ...
  reducers: {
    ...
    roles: (state: RoleView[], action: any, fullState: any) => RoleView[];
  ...
  selectors: {
    ...
    roles: (state: any, props?: any) => RoleView[];
    amountOfRecords: (state: any, props?: any) => number;
    values: (state: any, props?: any) => RoleTableView[];
  ...
  __keaTypeGenInternalSelectorTypes: {
    values: (roles: RoleView[]) => RoleTableView[];
    searchString: (
      urlSearchString: string,
      localSearchString: string | null,
    ) => string;
